...
- Not entirely clear on what the errors should be here. The Table 3 caption says
the fitting errors are smaller than the "NIRCam ZP and AB flux scale transformation
uncertainties of Appendix B.2, which are listed in column 11. These combined errors
are therefore used for the IGL parameters of Figure 11."
"""

zodi = None#'kelsall'

# These are the errors (in mags) in Table 3, column 11
col11 = [0.06, 0.07, 0.07, 0.06, 0.05, 0.04, 0.04]
